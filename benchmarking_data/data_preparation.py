...
def main():
    ...
    scier_ds = pd.read_json(
        "./benchmarking_data/original_datasets/scier.jsonl", lines=True
    )[["doc_id", "sentence", "ner"]]
    ...
    converted_nerd.to_parquet("./benchmarking_data/nerd.parquet")

    converted_multiconer = convert_dataset(multiconer)
    print(converted_multiconer.columns, "\n", converted_multiconer.head())
    converted_multiconer.to_parquet("./benchmarking_data/coner.parquet")

    print(scier_ds.columns, "\n", scier_ds.head())
    scier_ds.to_parquet("./benchmarking_data/scier.parquet")
